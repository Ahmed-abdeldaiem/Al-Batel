...
<div className=" py-20">
            ...
            <form className="max-w-lg mx-auto text-right" onSubmit={formik.handleSubmit}>
              <div className="relative z-0 w-full mb-5 group">
                ...
                <label
                  htmlFor="name"
                  className="peer-focus:font-medium absolute text-lg text-blue-900 dark:text-gray-400 duration-300 transform translate-y-6 scale-75 start-1 top-1 start-1 -z-10  peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                >
                   Name
                </label>
