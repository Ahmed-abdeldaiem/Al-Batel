...
const { rightToLeft, leftToRight, dir } = useContext(LanguageContext);
  ...
  <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
    ...
    <span className='text-green-600 text-lg'> <span className='text-blue-600'>966552214444+ :</span> <i className="fa-solid fa-square-phone"></i></span>
    <span className='text-green-600 text-lg'> <span className='text-blue-600'>info@albatelcpa.com :</span> <i className="fa-solid fa-envelope"></i></span>
    <span className='text-green-600 text-lg'> <span className='text-blue-600'>www.albatelcpa.com :</span> <i className="fa-solid fa-globe"></i></span>
    </div>
  ...
  <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
    <div className="sm:flex sm:items-center sm:justify-between">
      <Link to="" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
        <img src="/logo.png" className="h-8" alt="elbatel Logo" />
        <span className="self-center text-2xl text-green-800 font-semibold whitespace-nowrap dark:text-white">Al-Batel</span>
      </Link>
      <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
        <li>
          <Link to="contact" className="transition-all duration-500 text-blue-600 hover:text-green-600 hover:underline me-4 md:me-6">Contact Us</Link>
        </li>
