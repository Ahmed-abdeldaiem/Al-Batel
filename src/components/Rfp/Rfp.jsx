...
export default function Rfp() {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
        ...
        tax_registration: Yup.string()
        .min(15, "tax_registration must be 15 numbers")
       ,
       job: Yup.string()
        .min(3, "Name must be at least 3 characters")
      ...
      message: Yup.string()
        ...
        ,
        period_to: Yup.date()
        .typeError("Invalid date format").test(
          "is-after",
          "End date must be after start date",
          function (value) {
            const { period_from } = this.parent;
            return value && period_from ? new Date(value) > new Date(period_from) : true;
          }
        ),
  ...
  <div className=" py-20">
            ...
            طلب عرض سعر
              ...
              <form className="w-full md:w-10/12 lg:w-8/12  mx-auto text-right  rounded-3xl p-4" onSubmit={formik.handleSubmit}>
               {/* اسم الشركة */}
                <div className='p-2 '>
                ...
                <div className="relative z-0   mb-5 group">
                  ...
                  {formik.errors.commercial_registration && formik.touched.commercial_registration ? (
                    <div
                      className="p-4 mt-3 mb-4 text-sm text-red-800 rounded-lg bg-red-100/60 dark:bg-gray-800 dark:text-red-400"
                      role="alert"
                    >
...
{/* رقم التسجيل الضريبي */}
                ...
                <div className="relative z-0   mb-5 group">
                  ...
                  {formik.errors.tax_registration && formik.touched.tax_registration ? (
                    <div
                      className="p-4 mt-3 mb-4 text-sm text-red-800 rounded-lg bg-red-100/60 dark:bg-gray-800 dark:text-red-400"
                      role="alert"
                    >
...
<div className='p-2 flex gap-6 '>
  ...
  <DatePicker
      ...
      onChange={(date) => formik.setFieldValue("period_from", date)}
...
<DatePicker
  ...
  onChange={(date) => formik.setFieldValue("period_to", date)}
